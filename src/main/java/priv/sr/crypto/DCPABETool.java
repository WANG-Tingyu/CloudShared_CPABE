...
import priv.sr.crypto.BasicCommand.ForcibleCommand;
...
import priv.sr.crypto.utility.VersionProvider;
...
public class DCPABETool implements Runnable {
	...
	private static final CommandLine cmd = new CommandLine(new DCPABETool());
